    ...
    public class MovieServiceTest : IMovieService 
    {
        public List<MovieCardResponseModel> GetTopRevenueMovies()
        {
            ...
            var movies = new List<MovieCardResponseModel>
            {
                ...
                new MovieCardResponseModel {Id = 13, Title = "The Lord of the Rings: The Return of the King"},
                new MovieCardResponseModel {Id = 14, Title = "Harry Potter and the Philosopher's Stone"},
